...
external interface ReadableStream<R> {
    ...
    fun getReader(options: `T$8`): ReadableStreamBYOBReader
    fun getReader(): ReadableStreamDefaultReader<R>
    fun <T> pipeThrough(__0: `T$9`<R, T>, options: PipeOptions = definedExternally): ReadableStream<T>
